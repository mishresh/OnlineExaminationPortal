...
<div class="navbar">
  ...
  <a href="#">About</a>
  <a href="admin.php" class="right">Admin Login </a>
...
<!-- <div style="padding-center:0px; padding-left:50px; color: MidnightBlue; font-size: 20px; text-shadow: -1px 0 black, 0 1px OrangeRed, 1px 0 gold, 0 -1px red;">
 -->   <center><h2>
      <a href="admin/index.php">ADMIN LOGIN </a><br><br><br>
      <a href="examiner/index.php">Examiner LOGIN </a><br><br><br>
      <a href="examinee/index.php">Examinee LOGIN </a>
      </h2></center>
  </div></div>
